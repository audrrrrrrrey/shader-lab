Shader "shader lab/week 1/texture color blending" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag (Interpolators i) : SV_Target {
                ...
                float3 base = _baseTex.Sample(sampler_baseTex, i.uv).rgb;
                float3 blend = _blendTex.Sample(sampler_blendTex, i.uv).rgb;
                float3 color = 0;
